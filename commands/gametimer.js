...
QueenSew.newcmdaddtosew({pattern: 'wordgame$', fromMe: RS, desc: OYUN.description, warn: OYUN.caution}, (async (message, match) => {
...
QueenSew.newcmdaddtosew({on: 'text', fromMe: RS, dontAdCommandList: true, delownsewcmd: false}, (async (message, match) => {

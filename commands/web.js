...
QueenSew.newcmdaddtosew({pattern: 'ping$', fromMe: true, deleteCommand: false, desc: Lang.PING_DESC}, (async (message, match) => {
  ...
  await message.client.sendMessage(
    ...
    QueenSew.newcmdaddtosew({pattern: 'short ?(.*)', fromMe: RS, desc: Lang.URL}, (async (message, match) => {
    ...
    QueenSew.newcmdaddtosew({pattern: 'calc ?(.*)', fromMe: RS, desc: Lang.CALC }, (async (message, match) => {
